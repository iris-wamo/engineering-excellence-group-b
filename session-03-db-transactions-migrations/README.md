...
Internal team work management backend. This session builds on Session 02 and focuses on
database correctness: transactions, migrations, and query performance. The initial scope
is intentionally light; detailed implementation and documentation will land through
topic-specific PRs.
...
From the `session-03-db-transactions-migrations/` directory:
